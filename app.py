...
<style>
  ...
  .metric-label { font-size:20px; color:#666; text-transform:uppercase; letter-spacing:.05em; }
  .metric-value { font-size:36px; font-weight:700; color:#1a3a5c; margin-top:4px; }
  .metric-sub   { font-size:19px; color:#999; margin-top:2px; }
  .section-header { font-size:22px; font-weight:600; color:#2e6da4;
                    text-transform:uppercase; letter-spacing:.08em;
                    border-bottom:2px solid #2e6da4; padding-bottom:4px;
                    margin:24px 0 12px; }
  .note-box { background:#eef4fb; border-left:3px solid #2e6da4;
              padding:10px 14px; border-radius:4px;
              font-size:21px; color:#333; margin:8px 0; }
</style>
